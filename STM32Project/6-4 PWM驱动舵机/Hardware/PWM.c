...
void PWM_Init(void)
{
    ...
    TIM_TimeBaseInitStruct.TIM_Period = 20000 - 1;                 // ARR自动重装寄存器的值
    ...
    TIM_OC1Init(TIM2, &TIM_OCInitStruct);                      // TIM2的OC1通道上输出PWM波形，对应端口PA0
    ...
    GPIO_InitStruct.GPIO_Pin = GPIO_Pin_0;                // GPIO 0~15
